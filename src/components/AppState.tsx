...
interface InitializeCarAction extends Action<"INITIALIZE_CART"> {
  payload: {
...
const reducer = (
  state: AppStateValue,
  action: AddToCartAction | InitializeCarAction
) => {
...
export const useStateDispatch = () => {
  ...
  if (!dispatch) {
    throw new Error(
      "useSetState was called outside of the AppSetStateConext provider"
    );
  }
  return dispatch;
};
